...
#     queryset = CompanyList.objects.all(cor_id = id)
#     serializer = CompanyListSerializer(queryset, many=True)
#     return Response(serializer.data)
# # => id=1에 대해 리턴된 Response: {'cor_id': 1, 'cor_name': '삼성전자'}

# @api_view('[GET]')
# def newsdata_list(request, id):
#     queryset = NewsData.objects.all(cor_id = id)
